...
//   <h1 className='text-xl font-extralight whitespace-normal'>{item.title}</h1>
function Title({ item }) {
  ...
  return (
    <section className='flex flex-row border-b border-slate-800'>
      <div className='flex flex-wrap flex-row max-w-md  md:max-w-2xl pl-6 sm:pl-12 p-7'>
        <h1 className='text-xl font-extralight'>{item.title}</h1>
      </div>
      <div className='flex flex-row pt-7' ref={ref}>
        <motion.h2
          ...
          className='text-xl font-victor font-medium text-pink-700 mr-10'
        >
          {item.years}
        </motion.h2>
      </div>
  ...
  const EmailLink = () => {
    ...
    return (
      <motion.a
        ...
        href={mailtoLink}
      >
        <p className='text-xl font-medium font-victor text-pink-700'>
          Contact Me
        </p>
      </motion.a>
    );
          ...
          <div className='flex flex-col  md:flex-row border-b border-slate-800'>
            ...
            <div className='flex flex-col w-full md:w-1/2 border-l border-slate-800'>
              <div className='border-b border-slate-800 p-7 pl-6 sm:pl-12'>
                <h1 className='text-xl font-extralight '>BA Biology</h1>
              </div>
